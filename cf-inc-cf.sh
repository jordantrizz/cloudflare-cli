...
---------
    ...
    security    - Manage zone security settings
                    <zone> list
...
----------
	...
	clear       cache
	invalidate  url
	security    <zone> list|<setting> <value>
	template    list, apply
	search      zone, record
...
# -- HELP_CMDS_SHORT
# -----------------------------------------------
HELP_CMDS_SHORT="Commands: list, add, bulk, delete, change, clear, check, security, json, help, examples"
